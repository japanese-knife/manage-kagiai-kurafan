  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <ProjectScheduleView user={user} activeBrandTab="all" viewType="daily" sharedView={true} />
      </div>
      <div>
        <h2 className="text-lg font-semibold text-neutral-900 mb-6">BRAND-BASE 年間スケジュール</h2>
        <ProjectScheduleView user={user} activeBrandTab="BRAND-BASE" viewType="monthly" sharedView={true} />
      </div>
    </div>
  );
}