          ...
          <div className="bg-white rounded-2xl border border-neutral-200/50 shadow-xl p-6 sm:p-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center px-6 py-3 bg-primary-600 text-white font-medium rounded-lg hover:bg-primary-700 hover:shadow-soft-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
                {loading ? (
                  <span>処理中...</span>
                ) : (
