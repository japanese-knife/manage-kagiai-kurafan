...
export default function ProjectScheduleView({ user, activeBrandTab, viewType, creators = [], productCategories = [] }: ProjectScheduleViewProps) {
 ...
 // ヘッダー部分を共通化する関数
  ...
  // プロジェクト行を描画する関数
  const renderProjectRows = (brandProjects: Project[]) => {
    return (
      <>
