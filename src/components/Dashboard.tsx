            ...
            <thead className="bg-neutral-50 border-b border-neutral-200">
              <tr>
                ...
                {projectColumns.map(project => (
                  <th key={project} className="px-4 py-3 text-left text-sm font-semibold text-neutral-900 min-w-[150px] group relative">
                    <div className="flex items-center justify-between">
                      <span>{project}</span>
                      <button
                ...
                <th className="px-4 py-3 text-left text-sm font-semibold text-neutral-900 w-[150px]">
                  {showAddProject ? (
                    <div className="flex items-center gap-2" onClick={e => e.stopPropagation()}>
                      <input
                        ...
                        placeholder="プロジェクト名"
                        className="px-2 py-1 text-sm border border-neutral-300 rounded flex-1"
                        onKeyDown={(e) => {
            ...
            <tbody className="divide-y divide-neutral-100">
              ...
              {showAddBrand && (
                <tr className="bg-primary-50">
                  ...
                  <td className="px-4 py-3" colSpan={projectColumns.length + 3}>
...
{activeTab === 'schedule' && (
  <div className="space-y-8">
    <div>
      ...
      <ProjectScheduleView user={user} activeBrandTab="all" viewType="daily" creators={creators} productCategories={productCategories} />
    </div>
    <div>
